import{_ as n,V as s,W as a,Z as e}from"./framework-e5d7a6b2.js";const p={},l=e(`<h1 id="基本技巧" tabindex="-1"><a class="header-anchor" href="#基本技巧" aria-hidden="true">#</a> 基本技巧</h1><p>Basic Linked List Skills</p><ol><li><p>traversal</p><ul><li><p>迭代遍历</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token comment">// FOR：先序：访问</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p>Remove a Node from Linked List</p></li><li><p>Reverse a Linked List</p><p>见同向双指针内</p></li><li><p>Merge Two Linked Lists</p><p>见平行双指针内，这个是</p></li><li><p>Middle of a Linked List</p></li></ol>`,5),t=[l];function i(o,c){return s(),a("div",null,t)}const d=n(p,[["render",i],["__file","2. 基本技巧.html.vue"]]);export{d as default};
