...
1. **有线模式**：使用USB线（USB声卡）连接，提供稳定的传输速度，没有延迟，非常适合游戏和需要精准操作的场景。
2. **蓝牙模式**：通过蓝牙连接，适合日常办公和多设备切换，耗电较少，但延迟可能比2.4GHz稍高。
3. **2.4GHz模式**：通过2.4GHz的接收器连接，延迟低，传输稳定。适合对响应速度要求高但希望摆脱线缆的场景，尤其适合游戏玩家。
   1. Type A
   2. Type C


> 三模：就是支持三种链接模式，适合在不同的设备上快速切换，比如一台电脑和一台平板或手机。
...
3. **人体工学**：握持舒适，适合长时间使用；一些高级办公鼠标采用垂直设计，减少手腕疲劳。
