...
<div class="section-card-grid">
  <a class="section-card" href="./tensor.md">
    <span class="section-card__eyebrow">Basics</span>
    <h3>Tensor</h3>
    <p>PyTorch 的第一语言，所有模型、梯度和 batch 都建立在 tensor 之上。</p>
  </a>
  <a class="section-card" href="./workflow.md">
    <span class="section-card__eyebrow">Training loop</span>
    <h3>Workflow</h3>
    <p>从数据、模型、loss 到优化器和验证流程，形成最小可用训练闭环。</p>
  </a>
  <a class="section-card" href="./graph.md">
    <span class="section-card__eyebrow">Autograd</span>
    <h3>Graph</h3>
    <p>理解计算图、自动求导和为什么反向传播能自动工作。</p>
  </a>
  <a class="section-card" href="./classification.md">
    <span class="section-card__eyebrow">Example</span>
    <h3>Classification</h3>
    <p>用一个最典型的监督学习任务把模型训练过程串起来。</p>
  </a>
  <a class="section-card" href="./distributed.md">
    <span class="section-card__eyebrow">Scale</span>
    <h3>Distributed Training</h3>
    <p>Data parallel、collective communication、sharding、checkpoint 和 failure。</p>
  </a>
  <a class="section-card" href="./debugging.md">
    <span class="section-card__eyebrow">Reliability</span>
