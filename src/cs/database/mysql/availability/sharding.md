...
![img](https://i-blog.csdnimg.cn/blog_migrate/4147aa9a9ccb6fb588bd143c1dd5e588.png)
...
也正是由于配置无法统一管理、不支持异构系统的原因，后面又引入`Sharding-Proxy`来解决这两个问题，`Sharding-Proxy`可以将其理解成一个伪数据库，对于应用程序而言是完全透明的，它会以中间件的形式独立部署在系统中，部署形态如下：

![img](https://i-blog.csdnimg.cn/blog_migrate/182015f2df7d8be01216440a6c5e6d9b.png)
...
![img](https://i-blog.csdnimg.cn/blog_migrate/0f848ef1b1acba2be9c0a7c998db796e.png)
